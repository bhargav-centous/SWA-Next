...
export default function DisclaimerCard({ onContinue }) {
    ...
    return (
        <Card sx={{ pb: 2 }}>
            ...
            <Stack sx={{ pr: 1.5, pt: 2 }} direction='row' justifyContent='end'>
                <Button onClick={onContinue} disabled={!value} sx={{ bgcolor: 'background.green', color: 'common.white', fontSize: 14, fontWeight: 500 }} variant="contained">
                    Continue
                </Button>
            </Stack>
        </Card>
